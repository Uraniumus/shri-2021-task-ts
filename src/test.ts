...
import { contrast, fontColors, ColorsKeys, EffectsKeys } from './model';
console.log('colors:');
...
const isColor = (name:string):name is ColorsKeys => fontColors.hasOwnProperty(name);

const colorList:Array<ColorsKeys> = Object.keys(fontColors).filter(isColor);
